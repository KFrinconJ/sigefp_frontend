...
import DeleteUserForm from "../forms/usuarios/DeleteUserForm";
import EditUserForm from "../forms/usuarios/EditUserForm";
    ...
    },
    {
      cell: (row: RowData) => (
        <ButtonTableModal
          headerText="Usuario"
          idItem={row.id}
          formularioEditar={<EditUserForm />}
          formularioEliminar={<DeleteUserForm />}
        />
      ),
      ignoreRowClick: true,
      allowOverflow: true,
